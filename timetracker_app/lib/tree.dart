...
class Tree {
  ...
  Tree(Map<String, dynamic> dec) {
    ...
    assert (dec['class'] == "project" || dec['class']=='tasca');
...
Tree getTree() {
  String strJson = "{"
      ...
      "{ \"name\":\"transportation\", \"class\":\"tasca\", \"id\":6, \"active\":false, \"initialDate\":\"2020-09-22 16:04:56\", \"finalDate\":\"2020-09-22 16:05:22\", \"duration\":10, \"intervals\":[] }"
      "] "
      "}";
...
Tree getTreeTask() {
  String strJson = "{"
      "\"name\":\"transportation\",\"class\":\"tasca\", \"id\":6, \"active\":false, \"initialDate\":\"2020-09-22 13:36:08\", \"finalDate\":\"2020-09-22 13:36:34\", \"duration\":10,"
      "\"intervals\":["
